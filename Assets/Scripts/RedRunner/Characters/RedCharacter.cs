...
namespace RedRunner.Characters
{
	...
	public class RedCharacter : Character
	{
		...
		public float valueHor;
		public bool isHorLeft;
		public bool isHorRight;
		...
		void Update ()
		{
			...
			if(isHorRight)
            {
				valueHor = Mathf.MoveTowards(valueHor, 1f, Time.deltaTime *5);
            }
			if(isHorLeft)
            {
            ...
            {
				valueHor = Mathf.MoveTowards(valueHor, 0, Time.deltaTime * 5);
			}
			//Debug.Log(valueHor);
